...
void WDTimerDisable();
unsigned int getTimerBut1(unsigned int);
unsigned int getTimerBut2(unsigned int);
unsigned int getTimerBut3(unsigned int);
unsigned int getTimerBut4(unsigned int);
