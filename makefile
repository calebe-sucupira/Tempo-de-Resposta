...
app: start.o main.o gpio.o timer.o interrupt.o setup.o uart.o pad.o control_module.o clock_module.o 
	$(CHAIN)-ld $(OBJ)start.o $(OBJ)main.o $(OBJ)gpio.o $(OBJ)timer.o $(OBJ)interrupt.o $(OBJ)setup.o $(OBJ)uart.o $(OBJ)pad.o $(OBJ)control_module.o $(OBJ)clock_module.o -T $(SRC)memmap.ld -o $(OBJ)main.elf 
...
setup.o: $(SRC)setup.c                          
	$(CHAIN)-gcc $(CFLAGS) $(IPATH) -c $(SRC)setup.c -o $(OBJ)setup.o
